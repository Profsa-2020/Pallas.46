...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
     ...
     <div class="collapse navbar-collapse align-self-center" id="navbarNav">
          <ul class="navbar-nav mr-auto text-center">
               <li class="nav-item">
                    <a class="nav-link" href="con-empresa.php"><i class="fa fa-building fa-2x"
               ...
               <li class="nav-item">
                    <a class="nav-link" href="grupo-cli.php?ope=1&cod=0"><i class="fa fa-filter fa-2x" aria-hidden="true"></i><br />
                         Grupo de Cliente </a>
               </li>
               <li class="nav-item">
               ...
               <li class="nav-item">
                    <a class="nav-link" href="grupo-ser.php?ope=1&cod=0"><i class="fa fa-filter fa-2x" aria-hidden="true"></i><br />
                         Grupo de Serviço </a>
               </li>
               <li class="nav-item">
               ...
               <li class="nav-item">
                    <a class="nav-link" href="con-contrato.php?ope=1&cod=0"> <i class="fa fa-money fa-2x"
                              aria-hidden="true"></i><br /> Contratos </a>
               </li>
               <li class="nav-item">
                    <a class="nav-link" href="consulta-pro.php"><i class="fa fa-search fa-2x"
                              aria-hidden="true"></i><br /> Consultas </a>
               </li>
               <li class="nav-item">
                    <a class="nav-link" href="processo-con.php"><i class="fa fa-cogs fa-2x"
                              aria-hidden="true"></i><br /> Processos </a>
               </li>
               <li class="nav-item">
                    <a class="nav-link" href="con-usuario.php"><i class="fa fa-user-circle-o fa-2x"
          ...
          <span class="navbar-text text-center">
               <?php 
                    echo '<div>';
                    echo '<strong class="lit-1">' . $_SESSION['wrknomusu'] . '</strong>' . '<br />';
                    echo '<a class="nav-link" href="log-acesso.php" title="Abre página com consulta de Log de usuários, somente o administrador">' . '<span class="lit-2">' . date('d/m/Y H:i') . '</a></span>';
