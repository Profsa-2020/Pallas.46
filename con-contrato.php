...
<body id="box00">
     <h1 class="cab-0">Consulta de Contratos - SearchMidia - Profsa Informática</h1>
     <div class="row">
          <div class="col-md-12">
...
function carrega_con($sta, $dti, $dtf) {
     ...
     foreach ($reg as $lin) {
          $txt =  '<tr>';
          $txt .= '<td class="text-center"><a href="man-contrato.php?ope=2&cod=' . $lin['idcontrato'] . '" title="Efetua alteração do registro informado na linha"><i class="large material-icons">create</i></a></td>';
